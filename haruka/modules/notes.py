		...
		if note.is_reply:
			...
			try:
				...
				if excp.message == "Entity_mention_user_invalid":
					...
					message.reply_text("This note could not be sent, as it is incorrectly formatted, Please ask @CuTePsYcHo_110 or @CrAziE_BoTz_ChAt if you can't figure out why!")
